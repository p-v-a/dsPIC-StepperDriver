...
void InitPid () {
    ...
    pid_parameters.ki = _Q16ftoi (10);
    pid_parameters.kd = _Q16ftoi (2);
    pid_parameters.kt = _Q16ftoi (0.0);
    
    pid_parameters.wp = _Q16ftoi (0.5);
    pid_parameters.wd = _Q16ftoi (0.5);
    ...
    while (1) {
        ...
        switch (controller_state) {
            ...
            case CTRL_STATE_UPDATE_PID:
                ...
                UpdatePwm (&winding1, &power_supply_state, _Q16ftoi(100));
                UpdatePwm (&winding2, &power_supply_state, _Q16ftoi(100));
